...
export const SCALE_OPTIONS = ['1-5', '1-10', '0-100'] as const;
...
export const VISIBILITY_OPTIONS = ['PUBLIC', 'LINK_ONLY', 'PRIVATE'] as const;
...
export const BADGE_CODES = ['first-list', 'echo-eight', 'chorus-100', 'pioneer'] as const;
